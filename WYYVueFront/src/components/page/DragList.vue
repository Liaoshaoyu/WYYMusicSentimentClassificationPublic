        ...
        <div class="container">
            ...
            <div class="drag-box">
                <div class="drag-box-item">
                    ...
                    <draggable v-model="todos" @remove="removeHandle" :options="dragOptions">
                        <transition-group tag="div" id="todos" class="item-ul">
                            <div v-for="item in todos" class="drag-list" :key="item.id">
                                {{item.content}}
                            </div>
                        </transition-group>
                    </draggable>
